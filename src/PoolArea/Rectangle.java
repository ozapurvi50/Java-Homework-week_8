...
public class Rectangle {                                   //class name
    ...
    private double width;                                 //defining private integer value
    private double length;
    public Rectangle(double width, double length){        //instance method with parameters
        this.width = (width < 0) ? 0 : width;
        this.length = (length < 0) ? 0 : length;         //Ternary operator condition applied
    }
