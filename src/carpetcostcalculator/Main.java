package carpetcostcalculator;                                               //package name
 ...
 * 4. Write a class with the name Main. The class needs to have a main method. TEST EXAMPLE
...
public class Main {                                                                         // Class name
    ...
    public static void main(String[] args) {                                               //Main method
        ...
        Floor floor = new Floor(2.75, 4.0);
        Calculator calculator = new Calculator(floor, carpet);
        System.out.println("total = " + calculator.getTotalCost());                       //Print statement plus value from method

        carpet = new Carpet(1.5);                                                    //defining integer value to integer
        floor = new Floor(5.4, 4.5);                                         //defining integer value to integer
        calculator = new Calculator(floor, carpet);                                      //object creation with parameters
        System.out.println("total =" + calculator.getTotalCost());                       //Print statement plus value from method
