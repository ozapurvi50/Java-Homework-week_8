 ...
 */
public class Point {                           //Class name

    private int x;                            //Defined private integer
    private int y;
    ...
    public double distance(int x, int y){                  //Method to calculate distance from this point to another point (x,y)
        return Math.sqrt(this.x * this.x + this.y * this.y);

    }


    public double distance(Point another){          //Method to calculate distance from this point to another point
