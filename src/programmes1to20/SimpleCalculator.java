...
public class SimpleCalculator {                      //Class name
    ...
    public double getDivisionResult() {
        if (secondNumber == 0) {                                                 //Condition applied
            return 0;
        } else {
            return firstNumber / secondNumber;
        }
    ...
    public static void main(String[] main) {                                         //Main method
        SimpleCalculator calculator = new SimpleCalculator();

        calculator.setFirstNumber(5.0);
        calculator.setSecondNumber(4);
        System.out.println("add = " + calculator.getAdditionResult());               //Print statement with result value of method
        System.out.println("subtract = " + calculator.getSubtractionResult());      //Print statement with result value of method

        calculator.setFirstNumber(5.25);
        calculator.setSecondNumber(0);
        System.out.println("multiply = " + calculator.getMultiplicationResult());   //Print statement with result value of method
        System.out.println("divide = " + calculator.getDivisionResult());          //Print statement with result value of method
