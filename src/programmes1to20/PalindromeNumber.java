...
public class PalindromeNumber {                                          //Class name
    ...
    public static boolean isPalindrome(int number) {                     //Boolean method
        ...
        if (numberString.startsWith("_")) {                             //Condition applied
            numberString = numberString.substring(1);
        }
        String gnirtSrebmun = new StringBuffer(numberString).reverse().toString();
        return numberString.equals(gnirtSrebmun);                       //Return result
    }

    public static void main(String[] args) {
        System.out.println("Test -1221  " + PalindromeNumber.isPalindrome(-1221));         //→ should return true
        System.out.println("Test  707   " + PalindromeNumber.isPalindrome(707));           //→ should return true
        System.out.println("Test  11212 " + PalindromeNumber.isPalindrome(11212));        //→ should return false because reverse is 21211 and that is not equal to 11212.
    }
}
